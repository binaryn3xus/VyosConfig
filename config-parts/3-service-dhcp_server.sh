...
set service dhcp-server shared-network-name LAN subnet 10.0.10.0/24 name-server '10.0.254.6'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.0.20.0/24 name-server '10.0.254.6'
...
set service dhcp-server shared-network-name SERVERS subnet 10.0.30.0/24 name-server '10.0.254.6'
...
set service dhcp-server shared-network-name GUEST subnet 10.0.40.0/24 name-server '10.0.254.6'
