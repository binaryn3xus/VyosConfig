...
set firewall ipv4 forward filter rule 101 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 101 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 106 action 'jump'
set firewall ipv4 forward filter rule 106 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 106 jump-target 'guest-containers'
set firewall ipv4 forward filter rule 106 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 111 action 'jump'
set firewall ipv4 forward filter rule 111 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 111 jump-target 'lan-containers'
set firewall ipv4 forward filter rule 111 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 116 action 'jump'
set firewall ipv4 forward filter rule 116 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 116 jump-target 'servers-containers'
set firewall ipv4 forward filter rule 116 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 121 action 'jump'
set firewall ipv4 forward filter rule 121 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 121 jump-target 'trusted-containers'
set firewall ipv4 forward filter rule 121 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 126 action 'jump'
set firewall ipv4 forward filter rule 126 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 126 jump-target 'wan-containers'
set firewall ipv4 forward filter rule 126 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 131 action 'jump'
set firewall ipv4 forward filter rule 131 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 131 jump-target 'wireguard-containers'
set firewall ipv4 forward filter rule 131 outbound-interface interface-group 'IG_containers'
...
set firewall ipv4 forward filter rule 136 outbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 141 action 'accept'
set firewall ipv4 forward filter rule 141 inbound-interface interface-group 'IG_guest'
...
set firewall ipv4 forward filter rule 146 inbound-interface interface-group 'IG_containers'
...
set firewall ipv4 forward filter rule 151 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 151 jump-target 'lan-guest'
set firewall ipv4 forward filter rule 151 outbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 156 action 'jump'
set firewall ipv4 forward filter rule 156 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 156 jump-target 'servers-guest'
set firewall ipv4 forward filter rule 156 outbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 161 action 'jump'
set firewall ipv4 forward filter rule 161 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 161 jump-target 'trusted-guest'
set firewall ipv4 forward filter rule 161 outbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 166 action 'jump'
set firewall ipv4 forward filter rule 166 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 166 jump-target 'wan-guest'
set firewall ipv4 forward filter rule 166 outbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 171 action 'jump'
set firewall ipv4 forward filter rule 171 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 171 jump-target 'wireguard-guest'
set firewall ipv4 forward filter rule 171 outbound-interface interface-group 'IG_guest'
...
set firewall ipv4 forward filter rule 176 outbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 181 action 'accept'
set firewall ipv4 forward filter rule 181 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 181 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 186 action 'jump'
set firewall ipv4 forward filter rule 186 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 186 jump-target 'containers-lan'
set firewall ipv4 forward filter rule 186 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 191 action 'jump'
set firewall ipv4 forward filter rule 191 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 191 jump-target 'guest-lan'
set firewall ipv4 forward filter rule 191 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 196 action 'jump'
set firewall ipv4 forward filter rule 196 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 196 jump-target 'servers-lan'
set firewall ipv4 forward filter rule 196 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 201 action 'jump'
set firewall ipv4 forward filter rule 201 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 201 jump-target 'trusted-lan'
set firewall ipv4 forward filter rule 201 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 206 action 'jump'
set firewall ipv4 forward filter rule 206 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 206 jump-target 'wan-lan'
set firewall ipv4 forward filter rule 206 outbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 211 action 'jump'
set firewall ipv4 forward filter rule 211 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 211 jump-target 'wireguard-lan'
set firewall ipv4 forward filter rule 211 outbound-interface interface-group 'IG_lan'
...
set firewall ipv4 forward filter rule 216 outbound-interface interface-group 'IG_lan'
...
set firewall ipv4 forward filter rule 221 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 226 action 'jump'
set firewall ipv4 forward filter rule 226 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 226 jump-target 'containers-servers'
set firewall ipv4 forward filter rule 226 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 231 action 'jump'
set firewall ipv4 forward filter rule 231 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 231 jump-target 'guest-servers'
set firewall ipv4 forward filter rule 231 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 236 action 'jump'
set firewall ipv4 forward filter rule 236 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 236 jump-target 'lan-servers'
set firewall ipv4 forward filter rule 236 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 241 action 'jump'
set firewall ipv4 forward filter rule 241 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 241 jump-target 'trusted-servers'
set firewall ipv4 forward filter rule 241 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 246 action 'jump'
set firewall ipv4 forward filter rule 246 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 246 jump-target 'wan-servers'
set firewall ipv4 forward filter rule 246 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 251 action 'jump'
set firewall ipv4 forward filter rule 251 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 251 jump-target 'wireguard-servers'
set firewall ipv4 forward filter rule 251 outbound-interface interface-group 'IG_servers'
...
set firewall ipv4 forward filter rule 256 outbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 261 action 'accept'
set firewall ipv4 forward filter rule 261 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 261 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 266 action 'jump'
set firewall ipv4 forward filter rule 266 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 266 jump-target 'containers-trusted'
set firewall ipv4 forward filter rule 266 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 271 action 'jump'
set firewall ipv4 forward filter rule 271 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 271 jump-target 'guest-trusted'
set firewall ipv4 forward filter rule 271 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 276 action 'jump'
set firewall ipv4 forward filter rule 276 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 276 jump-target 'lan-trusted'
set firewall ipv4 forward filter rule 276 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 281 action 'jump'
set firewall ipv4 forward filter rule 281 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 281 jump-target 'servers-trusted'
set firewall ipv4 forward filter rule 281 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 286 action 'jump'
set firewall ipv4 forward filter rule 286 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 286 jump-target 'wan-trusted'
set firewall ipv4 forward filter rule 286 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 291 action 'jump'
set firewall ipv4 forward filter rule 291 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 291 jump-target 'wireguard-trusted'
set firewall ipv4 forward filter rule 291 outbound-interface interface-group 'IG_trusted'
...
set firewall ipv4 forward filter rule 296 outbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 301 action 'accept'
set firewall ipv4 forward filter rule 301 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 301 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 306 action 'jump'
set firewall ipv4 forward filter rule 306 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 306 jump-target 'containers-wan'
set firewall ipv4 forward filter rule 306 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 311 action 'jump'
set firewall ipv4 forward filter rule 311 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 311 jump-target 'guest-wan'
set firewall ipv4 forward filter rule 311 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 316 action 'jump'
set firewall ipv4 forward filter rule 316 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 316 jump-target 'lan-wan'
set firewall ipv4 forward filter rule 316 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 321 action 'jump'
set firewall ipv4 forward filter rule 321 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 321 jump-target 'servers-wan'
set firewall ipv4 forward filter rule 321 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 326 action 'jump'
set firewall ipv4 forward filter rule 326 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 326 jump-target 'trusted-wan'
set firewall ipv4 forward filter rule 326 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 331 action 'jump'
set firewall ipv4 forward filter rule 331 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 331 jump-target 'wireguard-wan'
set firewall ipv4 forward filter rule 331 outbound-interface interface-group 'IG_wan'
...
set firewall ipv4 forward filter rule 336 outbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 341 action 'accept'
set firewall ipv4 forward filter rule 341 inbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 341 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 346 action 'jump'
set firewall ipv4 forward filter rule 346 inbound-interface interface-group 'IG_containers'
set firewall ipv4 forward filter rule 346 jump-target 'containers-wireguard'
set firewall ipv4 forward filter rule 346 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 351 action 'jump'
set firewall ipv4 forward filter rule 351 inbound-interface interface-group 'IG_guest'
set firewall ipv4 forward filter rule 351 jump-target 'guest-wireguard'
set firewall ipv4 forward filter rule 351 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 356 action 'jump'
set firewall ipv4 forward filter rule 356 inbound-interface interface-group 'IG_lan'
set firewall ipv4 forward filter rule 356 jump-target 'lan-wireguard'
set firewall ipv4 forward filter rule 356 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 361 action 'jump'
set firewall ipv4 forward filter rule 361 inbound-interface interface-group 'IG_servers'
set firewall ipv4 forward filter rule 361 jump-target 'servers-wireguard'
set firewall ipv4 forward filter rule 361 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 366 action 'jump'
set firewall ipv4 forward filter rule 366 inbound-interface interface-group 'IG_trusted'
set firewall ipv4 forward filter rule 366 jump-target 'trusted-wireguard'
set firewall ipv4 forward filter rule 366 outbound-interface interface-group 'IG_wireguard'
set firewall ipv4 forward filter rule 371 action 'jump'
set firewall ipv4 forward filter rule 371 inbound-interface interface-group 'IG_wan'
set firewall ipv4 forward filter rule 371 jump-target 'wan-wireguard'
set firewall ipv4 forward filter rule 371 outbound-interface interface-group 'IG_wireguard'
...
set firewall ipv4 forward filter rule 376 outbound-interface interface-group 'IG_wireguard'
