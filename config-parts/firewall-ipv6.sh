...
set firewall ipv6 forward filter rule 121 inbound-interface interface-group 'IG_lan'
set firewall ipv6 forward filter rule 121 outbound-interface interface-group 'IG_lan'
...
set firewall ipv6 forward filter rule 126 outbound-interface interface-group 'IG_lan'
set firewall ipv6 forward filter rule 131 action 'accept'
set firewall ipv6 forward filter rule 131 inbound-interface interface-group 'IG_servers'
set firewall ipv6 forward filter rule 131 outbound-interface interface-group 'IG_servers'
...
set firewall ipv6 forward filter rule 136 outbound-interface interface-group 'IG_servers'
set firewall ipv6 forward filter rule 141 action 'accept'
set firewall ipv6 forward filter rule 141 inbound-interface interface-group 'IG_trusted'
set firewall ipv6 forward filter rule 141 outbound-interface interface-group 'IG_trusted'
...
set firewall ipv6 forward filter rule 146 outbound-interface interface-group 'IG_trusted'
set firewall ipv6 forward filter rule 151 action 'accept'
set firewall ipv6 forward filter rule 151 inbound-interface interface-group 'IG_wan'
set firewall ipv6 forward filter rule 151 outbound-interface interface-group 'IG_wan'
...
set firewall ipv6 forward filter rule 156 outbound-interface interface-group 'IG_wan'
set firewall ipv6 forward filter rule 161 action 'accept'
set firewall ipv6 forward filter rule 161 inbound-interface interface-group 'IG_wireguard'
set firewall ipv6 forward filter rule 161 outbound-interface interface-group 'IG_wireguard'
...
set firewall ipv6 forward filter rule 166 outbound-interface interface-group 'IG_wireguard'
